/** Icon component shape shared by lucide icons and our custom brand icons. */
export type IconType = React.ComponentType<{
  className?: string;
  strokeWidth?: number;
}>;

/** LinkedIn brand glyph (lucide dropped brand icons). Filled, ignores stroke. */
export const LinkedInIcon: IconType = ({ className }) => (
